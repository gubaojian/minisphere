...
engine_sources=src/engine/main.c \
   ...
   src/engine/api.c src/engine/async.c src/engine/audio.c src/engine/color.c \
   src/engine/commonjs.c src/engine/console.c src/engine/debugger.c \
   src/engine/font.c src/engine/galileo.c src/engine/geometry.c \
   src/engine/image.c src/engine/keyboard.c src/engine/matrix.c \
   src/engine/rng.c src/engine/screen.c src/engine/script.c \
   src/engine/shader.c src/engine/sockets.c src/engine/spherefs.c \
   src/engine/spk.c src/engine/utility.c
engine_libs= \
