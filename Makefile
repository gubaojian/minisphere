...
engine_sources=src/engine/main.c \
   ...
   src/engine/bytearray.c src/engine/color.c src/engine/commonjs.c \
   src/engine/console.c src/engine/debugger.c src/engine/file.c \
   src/engine/font.c src/engine/galileo.c src/engine/geometry.c \
   src/engine/image.c src/engine/input.c src/engine/logger.c \
   ...
   src/engine/surface.c src/engine/tileset.c src/engine/utility.c \
...
install: all
	...
	gzip docs/spherical-api.txt -c > $(installdir)/share/doc/minisphere/spherical-api.gz
